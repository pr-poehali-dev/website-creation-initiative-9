        ...
        <section className="section" id="program">
          <div className="wrap split">
            <R>
              ...
              <p className="lead" style={{ marginBottom: "24px" }}>Мне важно, чтобы обучение не перегружало. Я выстроила его так, чтобы вы постепенно вошли в инструмент, начали практиковаться и не оставались с вопросами один на один. Также предоставляю вам клиента для практики — знания сразу применяются.</p>
            </R>
            <R className="card">
              <ul className="ulist">
